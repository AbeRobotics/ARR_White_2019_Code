...
@Autonomous(name="Platform Right Bridge", group="Autonomous")
public class Auto_Platform_Right_Bridge extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        opModeDriveHelper.driveHorizontal(24, OPModeConstants.HorizontalDriveDirection.RIGHT);
    }
}
