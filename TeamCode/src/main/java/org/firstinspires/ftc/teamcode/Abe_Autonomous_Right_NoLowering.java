 ...
 */
@Autonomous(name="Competition Right No Lowering", group="Game Opmodes")
public class Abe_Autonomous_Right_NoLowering extends LinearOpMode{
    ...
    public void runOpMode(){
        ...
        sleep(opModeConstants.restTimeMilli);
        driveHelper.drive(50.5, OPModeConstants.AutonomousSpeed.MEDIUM, OPModeConstants.DriveDirection.FORWARD);
        sleep(opModeConstants.restTimeMilli);
        ...
        // Drive to crater
        driveHelper.drive(77.0, OPModeConstants.AutonomousSpeed.MEDIUM, OPModeConstants.DriveDirection.FORWARD);
