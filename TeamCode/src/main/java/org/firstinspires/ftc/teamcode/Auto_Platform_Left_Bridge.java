...
@Autonomous(name="Platform Left Bridge", group="Autonomous")
public class Auto_Platform_Left_Bridge extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        opModeDriveHelper.drive(3, OPModeConstants.DriveDirection.FORWARD);

        sleep(200);

        opModeDriveHelper.driveHorizontal(30, OPModeConstants.HorizontalDriveDirection.LEFT);
    }
}
