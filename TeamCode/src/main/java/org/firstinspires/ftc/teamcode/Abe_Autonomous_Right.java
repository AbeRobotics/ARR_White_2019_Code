 ...
 */
@Autonomous(name="Competition Right", group="Game Opmodes")
public class Abe_Autonomous_Right extends LinearOpMode{
...
*/
        ...
        driveHelper.driveTurn(OPModeConstants.TurnDirection.RIGHT, OPModeConstants.AutonomousSpeed.LOW, 45.0);
