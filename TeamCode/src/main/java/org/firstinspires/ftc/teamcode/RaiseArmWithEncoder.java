 ...
 */
public class RaiseArmWithEncoder extends IOPModeTaskBase {
    ...
    public RaiseArmWithEncoder(LinearOpMode opMode, HardwareMap hardwareMap, ElapsedTime elapsedTime, OPModeConstants opModeConstants){
